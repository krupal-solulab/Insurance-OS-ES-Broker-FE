...
const nav = [
  ...
  { label: "Why wholesale brokers", href: "#why" },
    ...
    <section className="relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-5 pb-20 pt-16 md:px-8 md:pb-28 md:pt-24">
        ...
        <h1 className="mt-6 max-w-4xl font-serif text-[2.5rem] leading-[1.05] tracking-[-0.02em] text-foreground md:text-[4.25rem]">
          The AI operating system built for <em className="text-accent not-italic">wholesale &amp; E&amp;S broker placement</em>.
        </h1>
        <p className="mt-7 max-w-2xl text-lg leading-relaxed text-ink-soft md:text-xl">
          Coverline reads every retail submission, ranks it against your carrier panel, and assembles the
          package — market matching, quote comparison, and retail agent communication, with your broker
      ...
      <div className="mx-auto grid max-w-7xl gap-14 px-5 py-20 md:grid-cols-12 md:gap-10 md:px-8 md:py-28">
        <div className="md:col-span-5">
          ...
          <h2 className="mt-5 font-serif text-3xl leading-[1.1] tracking-[-0.01em] md:text-[2.75rem]">
            Placement shouldn't take 10–14 days.
          </h2>
        </div>
        <div className="md:col-span-6 md:col-start-7">
          <p className="text-lg leading-relaxed text-ink-soft">
            Wholesale and E&amp;S brokers write high submission volume with lean placement teams. Brokers spend
            30%+ of their week reading documents, ranking every submission against a carrier panel by hand, and
            re-assembling the same package for each carrier — before a single quote comes back. Renewals repeat
            this every year, for every account already on the book.
          </p>
    ...
    <section id="how" className="rule-t">
      <div className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-4">
          ...
          {/* 02 Match */}
          <div className="rule-t rule-b bg-secondary/50 p-5">
            <div className="label-eyebrow mb-3">Sample view · Match</div>
            <ul className="space-y-2 text-xs">
              <li className="flex items-center gap-2">
                <Check className="h-3.5 w-3.5 text-success" /> 3 of 5 carriers in appetite
              </li>
              <li className="flex items-center gap-2">
          ...
          {/* 03 Package */}
          <div className="rule-t rule-b bg-secondary/50 p-5">
            <div className="label-eyebrow mb-3">Sample view · Package</div>
            <div className="font-serif text-lg leading-snug">Proceed to market — package for top 3 carriers.</div>
...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    tone: "next",
    items: [
      ["Submission Package Assembly", "Assemble a carrier-specific package straight from your carrier selection."],
      ["Retail Agent Communication", "Draft status updates, missing-info requests, no-market notices, and quote summaries — you send."],
      ["Quote Comparison & Recommendation", "Normalize carrier terms, classify subjectivity materiality, and recommend."],
    ],
  },
  {
    label: "On the roadmap",
    tone: "later",
    items: [["Binder & Policy Issuance Coordination"], ["Endorsement / Mid-Term Change Processing"], ["Renewal Remarketing"]],
  },
  {
    label: "Cross-cutting layers",
    tone: "later",
    items: [["Diligent Search & Compliance Documentation"], ["Carrier Appetite Intelligence Tracking"], ["Pipeline & Carrier Performance Reporting"]],
  },
];
      ...
      <div className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-ink-soft">
            Not a single point tool — the operating layer for how wholesale &amp; E&amp;S brokers match, place,
            and communicate with retail agents and carriers.
          </p>
        </div>

        <div className="mt-14 space-y-10">
          {tiers.map((tier, ti) => (
            <div key={`${tier.label}-${ti}`}>
      ...
      <div className="mx-auto max-w-7xl px-5 py-24 md:px-8 md:py-32">
        <div className="max-w-3xl">
          ...
          <p className="mt-7 max-w-2xl text-lg leading-relaxed text-ink-soft">
            See how Submission Market Matching, Package Assembly, and Retail Agent Communication run on your
            own book.
          </p>
          <div className="mt-10">
            <PrimaryButton>
